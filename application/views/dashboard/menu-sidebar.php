...
$menuItems = [  // The LINK is the most important part, everything else is dynamic based on that
    ...
    'Order Queue'       => [ 'link' => '/dashboard/orders',             'icon' => 'user',               'active' => false, 'rendered' => false],
    'Products'          => [ 'link' => '/dashboard/products',           'icon' => 'user',               'active' => false, 'rendered' => false],
...
switch ($role){
    case 'developer': # See Everything for Debug
        ...
        break;
    case 'bartender':
        $menuItems['Order Queue']['rendered'] = true;
        break;
}
